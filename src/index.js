...
app.get('/fabricantes',FabricanteController.list)
app.get('/fabricantes/form',FabricanteController.form)
app.post('/fabricantes/create',FabricanteController.create)
